    ...
    <div className="min-h-screen bg-black text-white px-6 py-16 font-light">
      <div className="max-w-4xl mx-auto space-y-14">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-light mb-2 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
            How We Keep Your Data Safe
          </h2>
          <ul className="list-disc list-inside text-gray-300 leading-relaxed text-base">
            <li>
