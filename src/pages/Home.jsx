...
export default function Home() {
  ...
  return (
    <div className="relative bg-black text-white overflow-hidden">
      <div className="relative z-10 space-y-12 md:space-y-20 px-4 sm:px-6">
        ...
        <motion.section
          ...
          className="relative text-center space-y-6 md:space-y-8 py-12 md:py-20"
        >
          <motion.div 
            variants={staggerContainer}
            initial="hidden"
          ...
          >
            ...
            <motion.p 
              variants={textReveal}
              className="text-base sm:text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed font-light"
            >
              Plan, track, and collaborate effortlessly with ProjectAccel — your all-in-one project management tool.
            </motion.p>
            ...
            <motion.div 
              variants={textReveal}
              className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mt-8 sm:mt-10"
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <Link 
                  to="/start-free-trial" 
                  className="bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300 text-gray-800 px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium border border-gray-200 transition-all duration-300 hover:shadow-lg hover:shadow-white/5 block"
                >
                  Start Free Trial
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <Link 
                  to="/schedule-demo" 
                  className="bg-transparent text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full border border-white/20 hover:border-white/50 transition-all duration-300 text-sm sm:text-base font-medium block"
                >
                  Schedule a Demo
                </Link>
              </motion.div>
            ...
            <motion.div 
              variants={textReveal}
              className="inline-flex items-center px-3 py-1 sm:px-4 sm:py-2 mt-8 sm:mt-12 rounded-full text-xs sm:text-sm text-gray-400 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300"
              whileHover={{ 
                scale: 1.05, 
                boxShadow: "0px 5px 15px -5px rgba(255,255,255,0.1)" 
              }}
        ...
        >
          <motion.h2 
            variants={textReveal}
            className="text-2xl sm:text-3xl md:text-4xl font-light mb-8 sm:mb-12 tracking-tight"
          >
            <motion.span 
              className="bg-gradient-to-r from-white via-gray-200 to-gray-300 bg-clip-text text-transparent inline-block"
              animate={{ 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 sm:gap-x-8 gap-y-6 sm:gap-y-8 max-w-2xl mx-auto px-4 sm:px-6">
            {[
              [<MdBarChart size={32} className="text-gray-100" />, "Plan with confidence: Visual timelines & Kanban boards keep everyone aligned."],
              [<MdTrackChanges size={32} className="text-gray-100" />, "Boost accountability: Assign tasks, set priorities, track progress."],
              [<MdAttachMoney size={32} className="text-gray-100" />, "Control budgets: Monitor time & costs in real time."],
              [<MdGroups size={32} className="text-gray-100" />, "Delight clients: Share project portals for transparency."]
            ].map(([icon, text], i) => (
              <motion.div
                key={i}
                variants={boxReveal}
                ...
                whileHover="hover"
                viewport={{ once: true }}
                className="border border-white/10 p-4 sm:p-6 rounded-xl transition-all duration-300 flex flex-col items-center text-center backdrop-blur-sm bg-white/[0.03]"
              >
                <motion.div 
                ...
                <p className="text-sm sm:text-base text-gray-300 font-light">{text}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto px-4 sm:px-6">
            {[
              [<FaRocket size={32} className="text-gray-100" />, "Plan & Create", "Set goals and map your path."],
              [<MdChecklist size={32} className="text-gray-100" />, "Assign & Execute", "Delegate tasks to your team."],
              [<MdBarChart size={32} className="text-gray-100" />, "Track & Optimize", "Get clear dashboards & reports."]
            ].map(([icon, title, desc], i) => (
              <motion.div
                key={i}
                variants={boxReveal}
                ...
                viewport={{ once: true }}
                custom={i}
                className="border border-white/10 p-4 sm:p-5 rounded-xl transition-all duration-300 flex flex-col items-center text-center backdrop-blur-sm bg-gradient-to-b from-white/[0.03] to-transparent"
              >
                <motion.div 
                ...
                <h3 className="text-base sm:text-lg font-medium mb-1 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">{title}</h3>
                <p className="text-xs sm:text-sm text-gray-300 font-light">{desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 max-w-4xl mx-auto px-4 sm:px-6">
            {[
              "Gantt & Kanban Views",
              "Time Tracking & Timesheets",
              "File Sharing & Discussions",
              ...
              <motion.div
                ...
                className="border border-white/10 p-3 sm:p-4 rounded-full hover:border-white/20 transition-all duration-300 flex items-center gap-2 backdrop-blur-sm"
                whileHover={{ 
                  scale: 1.05,
                  backgroundColor: "rgba(255,255,255,0.05)",
                  boxShadow: "0px 5px 15px -5px rgba(255,255,255,0.1)",
              ...
              >
                ...
                >
                  <MdCheckCircle size={18} className="text-gray-100" />
                </motion.div>
                <span className="text-xs sm:text-sm font-light">{text}</span>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-50px" }}
          className="text-center max-w-4xl mx-auto py-12 md:py-16 px-4 sm:px-6"
        >
          <motion.h2 
            variants={textReveal}
            className="text-2xl sm:text-3xl md:text-4xl font-light mb-8 sm:mb-12 tracking-tight"
          ...
          <motion.div 
            ...
            whileHover="hover"
            viewport={{ once: true }}
            className="border border-white/10 p-6 sm:p-8 rounded-xl transition-all duration-500 backdrop-blur-sm bg-gradient-to-b from-white/[0.05] to-transparent"
          >
            <motion.blockquote 
              className="italic text-base sm:text-lg md:text-xl text-gray-300 mb-3 sm:mb-4 font-light"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3, duration: 0.8 }}
            >
            ...
            <motion.p 
              className="text-sm sm:text-base font-medium bg-gradient-to-r from-white via-gray-200 to-gray-300 bg-clip-text text-transparent"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.5, duration: 0.8 }}
            >
        ...
        <motion.section
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-50px" }}
          className="text-center space-y-6 sm:space-y-8 py-12 md:py-20 px-4 sm:px-6"
        >
          <motion.h2 
            variants={textReveal}
          ...
          <Link to="/start-free-trial">
            <motion.button 
              variants={scaleUp}
              className="bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300 text-gray-800 px-8 sm:px-10 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium border border-gray-200 transition-all duration-300 hover:shadow-lg hover:shadow-white/5"
              whileHover={{ 
                scale: 1.05,
                boxShadow: "0px 10px 20px -5px rgba(255,255,255,0.15)",
                transition: { duration: 0.2 }
